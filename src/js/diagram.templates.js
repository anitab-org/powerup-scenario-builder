/**
 * @file diagram.templates.js
 * @author justKD
 * @fileoverview `export const diagramTemplates`
 * Templates for GoJS diagram components.
 */
    ...
    return $(
      ...
      $(
        ...
        new go.Binding("fill", "isSelected", function(s) {
          return s ? props.colors.selectedColor : "white";
        }).ofObject(),
      ),
      $(
        go.Panel,
        ...
        $(
          ...
          "Table",
          {
            ...
            itemTemplate: diagramTemplates.fieldTemplate(),
          },
  ...
  startNodeTemplate: () => {
    ...
    return $(
      ...
      $(
        go.Shape,
        {
          fill: props.colors.startColor,
          stroke: "gray",
          minSize: new go.Size(180, 21),
        },
        new go.Binding("fill", "isSelected", function(s) {
          return s ? props.colors.selectedColor : props.colors.startColor;
        }).ofObject(),
      ),
      $(
        go.Panel,
  ...
  questionNodeTemplate: () => {
    ...
    return $(
      ...
      $(
        go.Shape,
        {
          fill: props.colors.questionColor,
          stroke: "gray",
          minSize: new go.Size(180, 21),
        },
        new go.Binding("fill", "isSelected", function(s) {
          return s ? props.colors.selectedColor : props.colors.questionColor;
        }).ofObject(),
      ),
      $(
        go.Panel,
  ...
  answerNodeTemplate: () => {
    ...
    return $(
      ...
      $(
        go.Shape,
        {
          fill: props.colors.answerColor,
          stroke: "gray",
          minSize: new go.Size(180, 21),
        },
        new go.Binding("fill", "isSelected", function(s) {
          return s ? props.colors.selectedColor : props.colors.answerColor;
        }).ofObject(),
      ),
      $(
        go.Panel,
